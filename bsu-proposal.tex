...
\documentclass[thesis,proposal]{bsu-ms}
%\documentclass[project]{bsu-ms}  % for project reports
%\documentclass[thesis]{bsu-ms}  % for thesis
%\documentclass[project,proposal]{bsu-ms}  % for project proposal

% "bsu-ms" is our "in-house" class file for Boise State theses and project reports.
...
% in place of "Advisor"
\advisor{Foo The Great} % also the chair of your committee
...
\gradCoordinator{Jerry Fails}


% Document abstract - not needed for a proposal but still has to be defined
\abstract{} 
% An \emph{abstract} is a brief summary of the document.  A typical
...
This introduces the work to be done so it can be reasonably well understood by a faculty member
not working in the research area.

\chapter{\Masterstype\  Statement}

A concise statement of the thesis/project, e.g., the hypothesis to be tested, the thesis to be
...
\chapter{Methods}
The method to be followed in accomplishing the thesis/project statement, i.e., proposed algorithms,
procedures, controls, sample sizes, experiments, and expected results, etc.
...
\section{The Greatness of Foo}\label{ch:fooGreatness}
...
\section{The not so great things about Foo}
...
\chapter{\Masterstype\ Schedule}

A schedule for completion of the thesis.

\chapter{Artifacts}

A description of any artifacts beside the write-up for the
project or thesis, i.e., code, user's guide, etc. 
